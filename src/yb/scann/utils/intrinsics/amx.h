...
#ifndef SCANN_UTILS_INTRINSICS_AMX_H_
#define SCANN_UTILS_INTRINSICS_AMX_H_
...
SCANN_INLINE string_view SimdName() { return "AMX"; }
SCANN_INLINE bool RuntimeSupportsSimd() { return RuntimeSupportsAmx(); }
